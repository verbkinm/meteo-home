...
Download [OPEN-SMART] TFT LCD Shield 3.2inch ILI9329.zip
from  https://drive.google.com/open?id=0B6uNNXJ2z4CxYktCQlViUkI1Sms
The library is compatible for Arduino UNO and MEGA2560.
/***********************************************************************************************************/
!!!NOTE:
...
We have test the four examples in the derectory of D:\arduino-1.6.5-r2\libraries\OPENSMART_TFT\examples\3.2inch ILI9329.
/*************************************************************************************************************/

Please also copy the information from the serial monitor of your Arduino IDE, thank you.
