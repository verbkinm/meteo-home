...
#define SUPPORT_7783
//#define SUPPORT_7789
//#define SUPPORT_61505
#define SUPPORT_61509
...
void MCUFRIEND_kbv::setRotation(uint8_t r)
{
    ...
    case 1:                    //LANDSCAPE: 90 degrees
        val = 0x38;             //MY=0, MX=0, MV=1, ML=0, BGR=1
        break;
...
void MCUFRIEND_kbv::pushColors(uint16_t color)
{
  CS_ACTIVE;
  CD_DATA;
  write16(color);
...
//			  0x0012, 0x013A,		   //VCMR=1, PSON=1, PON=1, VRH=10 vanhan123
		...
		static const uint8_t R61581_regValues[] PROGMEM = {  //from MCHIP Graphics Lib drvTFT001.c
			// Synchronization after reset
			TFTLCD_DELAY, 2,
			0xff, 0,
			0xff, 0,
			...
			0xc0, 8, 0x13,0x3b,0x00,0x00,0x00,0x01,0x00,0x43,
			0xc1, 4, 0x08,0x1b,0x08,0x08,
			0xc4, 4, 0x11,0x01,0x73,0x01,
			0xc6, 1, 0x00,
			0xc8, 10,0x0F,0x05,0x14,0x5C,0x03,0x07,0x07,0x10,0x00,0x23,
			0x10, 9, 0x07,0x07,0x53,0x0C,0x14,0x05,0x0F,0x23,0x00,
			0x35, 1, 0x00,
			0x44, 2, 0x00,0x01,
			0xd0, 4, 0x07,0x07,0x1D,0x03,
			0xd1, 3, 0x03,0x5b,0x10,
			0xd2, 3, 0x03,0x24,0x04,
        ...
        init_table(R61581_regValues, sizeof(R61581_regValues));
		p16 = (int16_t *) & HEIGHT;
        *p16 = 480;
        p16 = (int16_t *) & WIDTH;
        *p16 = 320;
...
0x29,0,	
    ...
    case 0xB509:
        ...
        static const uint16_t R61509V_regValues[] PROGMEM = {
            ...
            0x0001, 0x0100,
            0x0002, 0x0100,
            0x0003, 0x9030,     //1030, should set 9030 if use ST7793
            0x0009, 0x0001,
            0x000C, 0x0000,
            0x0090, 0x8000,
            0x000F, 0x0000,
